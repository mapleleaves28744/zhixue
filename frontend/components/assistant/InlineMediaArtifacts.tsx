...
import { ImmersiveClassroomCard } from "@/components/assistant/ImmersiveClassroomCard"
...
export function InlineMediaArtifacts({ refs }: InlineMediaArtifactsProps) {
  ...
  return (
    <div className="flex w-full flex-col gap-3">
      {refs.map((ref) =>
        ref.subtype === "immersive_classroom" ? (
          <ImmersiveClassroomCard key={ref.id} artifact={ref} />
        ) : (
