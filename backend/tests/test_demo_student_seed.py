...
def test_init_demo_student_data_imports_seed_graph_helper() -> None:
    module = importlib.import_module("scripts.init_demo_student_data")
    seed_module = importlib.import_module("scripts.import_seed_knowledge_graph")
    assert hasattr(module, "ensure_demo_student_data")
    assert hasattr(seed_module, "import_graph")
