 ...
 *
 * Features:
 *   ← → ↑ ↓ / wheel / space / PgUp PgDn / Home End  navigation
 *   F  fullscreen
...
(function(){
  ...
  timerCount.textContent = (idx + 1) + ' / ' + total;
    ...
    /* ===== Mouse wheel (scroll down = next, up = prev) ===== */
    let wheelLock = 0;
    document.addEventListener('wheel', function (e) {
      if (overview && overview.classList.contains('open')) return;
      if (notes && notes.classList.contains('open')) return;
