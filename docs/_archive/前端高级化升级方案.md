...
> 文档状态：**已执行方案与历史决策记录**
> Sprint 1-4 已完成。当前前端事实请读取 [`docs/12_前端页面设计/01_前端页面总览.md`](../12_前端页面设计/01_前端页面总览.md) 和 [`change_1-任务进度.md`](change_1-任务进度.md)；本文中的未完成描述可能是执行前快照。
...
**约束**（必须遵守）：按 `AGENTS.md` 与 [`Codex开发任务拆分.md`](Codex开发任务拆分.md) §1.2，**默认不 React 重做页面**；升级主战场是 `frontend/public/stitch-pages/` + 共享资源；Next 层仅增强壳层与全局能力。
